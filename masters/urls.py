...
urlpatterns = [
    ...
    path(
        'api/locations/lookup/', views.LocationLookupAPIView.as_view(), name='api_location_lookup'
    ),
    path(
        'api/customers/search/', views.CustomerSearchAPIView.as_view(), name='api_customer_search'
    ),
    path(
        'api/suppliers/search/', views.SupplierSearchAPIView.as_view(), name='api_supplier_search'
    ),
]
